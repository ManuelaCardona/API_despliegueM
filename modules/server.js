...
class Server {
    constructor() {
        ...
        this.categoriasPath = '/api/categorias'; // Define la ruta base para las operaciones relacionadas con categorias
    ...
    routes() {
        ...
        this.app.use(this.categoriasPath, require('../routes/categorias')); // Ruta para las operaciones relacionadas con categorias
